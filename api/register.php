...
<body>
            ...
            <div class="col-md-6">
                <div class="card bg-black rounded px-5 py-5"> <span class="circle"><i class="fa fa-check"></i></span>
                    ...
                    <form action="verification.php">
                        <div class="d-flex">
                            <div class="form-input w-100"> <i class="fa fa-pencil"></i> <input type="text"
                                    class="form-control" placeholder="First name"> </div>
                            <div class="form-input w-100 ml-2"> <i class="fa fa-user"></i> <input type="text"
                        ...
                        <div class="d-flex">
                            <div class="form-input w-100"> <i class="fa fa-lock"></i> <input type="password"
                                    class="form-control" placeholder="Password"> </div>
                            <div class="form-input w-100 ml-2"> <i class="fa fa-key"></i> <input type="password"
                                    class="form-control" placeholder="Confirm Password"> </div>
                        </div>
                        <div class="form-input input-group">

                            <ul class="input-group-text nav nav-pills p-0" id="pills-tab" role="tablist">
                                <li class="nav-item p-0" role="presentation">
                                    <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home"
                                        role="tab" aria-controls="pills-home" aria-selected="true">PSN</a>
                                </li>
                                <li class="nav-item p-0" role="presentation">
                                    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile"
                                        role="tab" aria-controls="pills-profile" aria-selected="false">XBOX</a>
                                </li>
                                <li class="nav-item p-0" role="presentation">
                        ...
                        <div class="form-check"> <input class="form-check-input" type="checkbox" value=""
                                ...
                                agree to all <a class="text-light link-primary" href="terms.php">Terms of Service</a>
                    ...
                    <div class="text-center mt-4"> <span>Already a member?</span> <a href="login.php"
    ...
    <footer class="border-top p-4 bg-black">
