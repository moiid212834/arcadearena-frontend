            ...
            <div class="card">
                <div class="row g-0">
                    ...
                    <div class="collapse" id="collapseExample">
                        ...
                        <div class="col-8 col-lg-5 col-xl-3 border-right position-absolute bg-white"
                            style="top: 75px;height: 84.6%;; z-index: 90;">
                            ...
                            <a href="#" class="list-group-item list-group-item-action border-0">
                                <div class="badge bg-success float-right">5
                                </div>
                            ...
                            <a href="#" class="list-group-item list-group-item-action border-0">
                                <div class="badge bg-success float-right">2
                                </div>
                                <div class="d-flex align-items-start">
                    ...
                    <div class="col-12">
                        <div class="py-2 px-3 border-bottom">
                            <div class="d-flex align-items-center py-1">
                                <button class="btn btn-light mr-4" type="button" data-toggle="collapse"
                            ...
                            <div class="chat-messages p-4">
                                ...
                                <div class="chat-message-left pb-4">
                                    ...
                                    <div class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                                        <div class="font-weight-bold mb-1">
                                            Sharon Lessman</div>
                                        Sit meis deleniti eu, pri vidit
                                        meliore docendi ut, an eum erat
                                        animal commodo.
                                    </div>
                                </div>
                                ...
                                <div class="chat-message-left pb-4">
                                    ...
                                    <div class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                                        <div class="font-weight-bold mb-1">
                                            Sharon Lessman</div>
                                        Sed pulvinar, massa vitae interdum
                                        pulvinar, risus lectus porttitor
                                        magna, vitae commodo lectus mauris
                                        et velit.
                                        Proin ultricies placerat imperdiet.
                                        Morbi varius quam ac venenatis
                                        tempus.
                                    </div>
                                </div>
                                ...
                                <div class="chat-message-right mb-4">
                                    ...
                                    <div class="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
                                        ...
                                        ullamcorper, nunc enim ultrices
                                        massa, id dignissim metus urna eget
                                        purus.
                                    </div>
                                </div>
    ...
    <div class="row pr-md-3">
        <div class="col-12">
            ...
            <div class="alert alert-light border" role="alert">
                ...
                <a class="alert-link" href="#">Reply</a> |
                <a class="link-danger" href="#">Dismiss</a>
            </div>
            <div class="alert alert-light border" role="alert">
                <h5>Meessage</h5>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. </p>
