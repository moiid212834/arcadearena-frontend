...
<body>
    ...
    <div class="content bg-black" id="top">
        <nav class="navbar navbar-expand-md fixed-top navbar-dark bg-black animate__animated animate__slideInDown" style="height: 90px;">
            <div class="container-fluid py-2" style="background-color: #000000aa;">
                <a class="navbar-brand" href="#"><img src="assets/logo/logo.svg" alt="Arcade Arena"
                ...
                <div class="collapse navbar-collapse" id="navbarID">
                    <div class="navbar-nav mx-auto">
                        <a class="nav-link ml-5 ml-md-0 active" aria-current="page" href="#top">Home</a>
                        <a class="nav-link ml-5" aria-current="page" href="#torneos">Torneos</a>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-9">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="text-center">
                                    <h1 id="overlays" class="mt-5">Overlays</h1>
                            ...
                            <div class="col-md-6">
                                <h1 id="torneos" class="text-center mt-5">Tornieos</h1>
                                <iframe class="w-100"
                                    src="https://player.twitch.tv/?video=882705658&parent=arcadearena-frontend.vercel.app"
                                    frameborder="0" allowfullscreen="true" scrolling="no" height="230"
                                    width="620"></iframe>
                            </div>
                    ...
                    <div id="lohas" class="mt-5 mb-2 mx-2 p-1">
                        <div class="">
                    ...
                    <div class="container-fluid">
                        <div class="text-light">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="text-center">
                                        <h1 id="tv" class="mt-5">Arcade Arena Tv</h1>
                                        <div class="rounded p-1 border border-dark">

                                            <iframe
                                                src="https://www.youtube.com/embed/?listType=user_uploads&list=CODLeague"
                                ...
                                <div class="col-md-6">
                                    <h1 id="discord" class="text-center mt-5">Discord</h1>
                                    <iframe src="https://titanembeds.com/embed/803309937262329928" height="410"
